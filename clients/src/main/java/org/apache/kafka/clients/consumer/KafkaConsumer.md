...
* <h3><a name="multithreaded">Multi-threaded Processing</a></h3>
  * ⚠️Kafka consumer is NOT thread-safe ⚠️
    * -> 👀user's responsibility -- to ensure -- multi-threaded access is properly synchronized 👀
      * Otherwise, Un-synchronized access -> will result in `ConcurrentModificationException`
